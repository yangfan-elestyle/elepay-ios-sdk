Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/4.9.2/ElepaySDK.xcframework.zip", :sha256 => "966960ff83cce09c544d9f92f61af1ea0b566b5e90eba6f179697e261d6bc020" }
