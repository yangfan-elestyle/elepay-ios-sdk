...
update_podspec_from_template "ElepayCheckoutPlugin.podspec" "ElepayCheckoutPlugin.xcframework.zip"
...
update_swift_package() {
    ...
    replace_checksum "ElepayCheckoutPlugin.xcframework.zip" "<ElepayCheckoutPlugin_sha256>"
