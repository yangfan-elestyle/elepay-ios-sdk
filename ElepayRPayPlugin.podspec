Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/5.0.1/ElepayRPayPlugin.xcframework.zip", :sha256 => "f4a939247e0a697aa282aeb1ffc20faceff8237467d0990ce15728bbfed71ba8" }
