Pod::Spec.new do |s|
  s.name         = 'ElepayCore'
  s.version      = '1.1.2' # Version from Package.swift for Elepay binaries
  ...
  s.source       = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/1.1.2/ElepayCore.xcframework.zip", :sha256 => "3e35c0c0c7f5d6859468ec4e91509a6cd9d35c57b814f76b29f264eb857f9584" }
