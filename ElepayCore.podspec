Pod::Spec.new do |s|
  s.name         = 'ElepayCore'
  s.version      = '5.0.1' # Version from Package.swift for Elepay binaries
  ...
  s.source       = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/5.0.1/ElepayCore.xcframework.zip", :sha256 => "e832a62236c8fcb15d54f12728629935e0f78a5a61dfe0dea17d2872ff788950" }
