Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/4.9.2.2/ElepayStripeApplePayPlugin-pods.xcframework.zip", :sha256 => "3153692942a9510b70218d791a0b0343e65c1db11e8576786f83ad3a1462948a" }
