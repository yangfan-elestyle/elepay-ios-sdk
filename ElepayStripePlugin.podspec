Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/5.0.2/ElepayStripePlugin-pods.xcframework.zip", :sha256 => "eee0f9a93dc709b65cefd51d1ad0bbe701c29caee49ee73f8386720cdf9940bb" }
