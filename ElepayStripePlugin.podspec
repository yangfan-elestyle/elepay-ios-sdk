Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/1.0.5/ElepayStripePlugin.xcframework.zip", :sha256 => "58c2162cd887a20fb4104685773fa4c0392390a535ecd0f6c67c57912388968e" }

  s.platform         = :ios, "13.0"
  s.swift_versions   = ['5.9']

  s.dependency 'ElepaySDK'
  s.dependency 'StripeCore', '24.9.0'
  s.dependency 'Stripe', '24.9.0'
  s.dependency 'StripeApplePay', '24.9.0'
  # s.dependency 'Stripe3DS2', '24.9.0'
  s.dependency 'StripeUICore', '24.9.0'
  s.dependency 'StripePayments', '24.9.0'
  s.dependency 'StripePaymentsUI', '24.9.0'
