Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/yangfan-elestyle/elepay-ios-sdk/releases/download/1.0.7/ElepayStripePlugin.xcframework.zip", :sha256 => "58c2162cd887a20fb4104685773fa4c0392390a535ecd0f6c67c57912388968e" }
